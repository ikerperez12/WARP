...
export function initThreeScene() {
  ...
  function render() {
    ...
    const carrierTargetX = isMobile ? -1.3 : -2.18;
    ...
    const padScale = 0.001 + mousePadReveal * 1.25;
    ...
    const mouseLocalX = (isMobile ? -0.025 : -0.125) + (1 - mouseReveal) * -0.08;
    const mouseLocalY = 0.032;
