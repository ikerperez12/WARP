...
export function initThreeScene() {
  ...
  function render() {
    ...
    const carrierTargetX = isMobile ? -5.36 : -2.62;
    const carrierTargetY = -0.094 - state.scroll * 0.01;
    const carrierTargetZ = isMobile ? 0.28 : 0.3;
    ...
    const mouseLocalX = (isMobile ? 0.08 : 0.22) + (1 - mouseReveal) * -0.06;
    const mouseLocalY = 0.036;
    const mouseLocalZ = 0.02;
    ...
    const mouseScale = 0.001 + mouseReveal * 0.82;
