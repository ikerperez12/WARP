...
import { asset } from '../portfolioData.js'
...
export default class Sounds
{
    ...
    setSettings()
    {
        const withAssetPaths = (_sounds) => _sounds.map((_sound) => asset(_sound))

        this.settings = [
            {
                name: 'reveal',
                sounds: withAssetPaths(['./sounds/reveal/reveal-1.mp3']),
                minDelta: 100,
                velocityMin: 0,
            ...
            {
                name: 'brick',
                sounds: withAssetPaths(['./sounds/bricks/brick-1.mp3', './sounds/bricks/brick-2.mp3', './sounds/bricks/brick-4.mp3', './sounds/bricks/brick-6.mp3', './sounds/bricks/brick-7.mp3', './sounds/bricks/brick-8.mp3']),
                minDelta: 100,
                velocityMin: 1,
            ...
            {
                name: 'bowlingPin',
                sounds: withAssetPaths(['./sounds/bowling/pin-1.mp3']),
                minDelta: 0,
                velocityMin: 1,
            ...
            {
                name: 'bowlingBall',
                sounds: withAssetPaths(['./sounds/bowling/pin-1.mp3', './sounds/bowling/pin-1.mp3', './sounds/bowling/pin-1.mp3']),
                minDelta: 0,
                velocityMin: 1,
                velocityMultiplier: 0.5,
                volumeMin: 0.35,
            ...
            {
                name: 'carHit',
                sounds: withAssetPaths(['./sounds/car-hits/car-hit-1.mp3', './sounds/car-hits/car-hit-3.mp3', './sounds/car-hits/car-hit-4.mp3', './sounds/car-hits/car-hit-5.mp3']),
                minDelta: 100,
                velocityMin: 2,
                velocityMultiplier: 1,
                volumeMin: 0.2,
            ...
            {
                name: 'woodHit',
                sounds: withAssetPaths(['./sounds/wood-hits/wood-hit-1.mp3']),
                minDelta: 30,
                velocityMin: 1,
                velocityMultiplier: 1,
                volumeMin: 0.5,
            ...
            {
                name: 'screech',
                sounds: withAssetPaths(['./sounds/screeches/screech-1.mp3']),
                minDelta: 1000,
                velocityMin: 0,
                velocityMultiplier: 1,
                volumeMin: 0.75,
            ...
            {
                name: 'uiArea',
                sounds: withAssetPaths(['./sounds/ui/area-1.mp3']),
                minDelta: 100,
                velocityMin: 0,
                velocityMultiplier: 1,
                volumeMin: 0.75,
            ...
            {
                name: 'carHorn1',
                sounds: withAssetPaths(['./sounds/car-horns/car-horn-1.mp3']),
                minDelta: 0,
                velocityMin: 0,
                velocityMultiplier: 1,
                volumeMin: 0.95,
            ...
            {
                name: 'carHorn2',
                sounds: withAssetPaths(['./sounds/car-horns/car-horn-2.mp3']),
                minDelta: 0,
                velocityMin: 0,
                velocityMultiplier: 1,
                volumeMin: 0.95,
            ...
            {
                name: 'horn',
                sounds: withAssetPaths(['./sounds/horns/horn-1.mp3', './sounds/horns/horn-2.mp3', './sounds/horns/horn-3.mp3']),
                minDelta: 100,
                velocityMin: 1,
                velocityMultiplier: 0.75,
                volumeMin: 0.5,
    ...
    setEngine()
    {
        ...
        this.engine.sound = new Howl({
            src: [asset('./sounds/engines/1/low_off.mp3')],
            loop: true
        })
