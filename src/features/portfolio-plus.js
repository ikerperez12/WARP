  ...
  const scenarios = {
    es: {
      launch: {
        ...
        description: 'Salida r�pida con base s�lida para evolucionar producto sin rehacer arquitectura en la siguiente fase.',
        tags: ['Vite', 'Node.js', 'Docker', 'Cloud Run', 'PostgreSQL'],
        steps: [
          'Definir alcance m�nimo y m�tricas de �xito de lanzamiento.',
          'Construir API + frontend con contratos versionados.',
          'Configurar pipeline CI/CD y monitorizaci�n inicial.',
        ],
        kpiA: '14',
        kpiB: '99.9',
        kpiALabel: 'd�as a primera release',
        kpiBLabel: '% objetivo de uptime',
      },
      scale: {
        button: 'Escalado estable',
        title: 'Escalado estable con observabilidad activa',
        description: 'Estrategia para crecer tr�fico sin perder control de costes, latencia ni trazabilidad operativa.',
        tags: ['Nginx', 'Redis', 'BigQuery', 'Looker', 'SLOs'],
        steps: [
          'Instrumentar m�tricas de negocio y m�tricas t�cnicas por servicio.',
          'Introducir cach� selectiva y pol�ticas de autoscaling controlado.',
          'Crear paneles de alertas por umbral de latencia y error budget.',
        ],
        kpiA: '35',
        kpiB: '48',
        kpiALabel: '% menos latencia pico',
        kpiBLabel: '% menos incidencias cr�ticas',
      },
      secure: {
        button: 'Fortificaci�n seguridad',
        title: 'Fortificaci�n seguridad desde dise�o',
        description: 'Hardening continuo para proteger superficie p�blica y acortar el tiempo de respuesta ante incidentes.',
        tags: ['CSP', 'Rate Limit', 'WAF', 'IAM', 'Audit Logs'],
        steps: [
          'Aplicar validaci�n estricta de entradas y salida de errores segura.',
